<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			<form action="" id="manage-upload-apdk">
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-upload-apdk">Save</button>
...
$(function () {
  ...
  myDropzone.on("success",function(file,resp){
	...
	$('#manage-upload-apdk').submit(function(e){
		e.preventDefault()
		start_load()
		$.ajax({
			url:'ajax.php?action=save_upload_apdk',
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.href = 'index.php?page=document_list_apdk'
					},2000)
				}
			}
		})
