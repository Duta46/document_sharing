<div class="col-lg-12">
  <div class="card card-outline card-primary">
    <div class="card-body">
      <form action="" id="manage-upload-disda">
        ...
        <div class="callout callout-info">
          ...
          <div class="table table-striped files" id="previews">
            ...
            if(isset($file_json) && !empty($file_json)):
              foreach(json_decode($file_json) as $k =>
              $v): if(is_file('assets/uploads/'.$v)): $_f = file_get_contents('assets/uploads/'.$v); $dname = explode('_', $v); ?>
              <div class="def-item">
                ...
                <div id="" class="row mt-2 dz-processing dz-success dz-complete">
                  ...
                  <div class="col d-flex align-items-center">
                    <p class="mb-0">
                      ...
                      (<span
                        ><strong><?php echo filesize('assets/uploads/'.$v) ?></strong> Bytes</span
                      >)
                    </p>
                    <strong class="error text-danger" data-dz-errormessage=""></strong>
                  </div>
    ...
    <div class="card-footer border-top border-info">
      <div class="d-flex w-100 justify-content-center align-items-center">
        <button class="btn btn-flat bg-gradient-primary mx-2" form="manage-upload-disda">Save</button>
...
<script>
  ...
  $("#manage-upload-disda").submit(function (e) {
    e.preventDefault();
    start_load();
    $.ajax({
      url: "ajax.php?action=save_upload_disda",
      ...
      success: function (resp) {
        if (resp == 1) {
          ...
          setTimeout(function () {
            location.href = "index.php?page=document_list_disda";
          }, 2000);
        }
      },
    });
